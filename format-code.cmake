...
foreach(SOURCE_FILE ${ALL_SOURCE_FILES})
    ...
    if(NOT FORMAT_RESULT EQUAL 0)
        message(WARNING "Failed to format: ${SOURCE_FILE} (exit code: ${FORMAT_RESULT})")
        if(FORMAT_ERROR)
            message(WARNING "Error output: ${FORMAT_ERROR}")
        endif()
        if(FORMAT_OUTPUT)
            message(WARNING "Standard output: ${FORMAT_OUTPUT}")
        endif()
    else()
